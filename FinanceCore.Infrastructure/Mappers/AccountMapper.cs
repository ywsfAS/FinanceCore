...
namespace FinanceCore.Infrastructure.Mappers
{
    public static class AccountMapper
    {
        ...
        {
            return Account.Load(model.Id, model.UserId, model.Name, (EnAccountType)model.AccountTypeId,new Money(model.Balance,(EnCurrency)model.CurrencyId), new Money(model.InitialBalance,(EnCurrency)model.CurrencyId), model.IsActive, model.CreatedAt, model.UpdatedAt ,null,model.RowVersion);
        }
    }
}
