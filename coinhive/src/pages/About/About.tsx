        ...
        <main className={styles.page}>
            ...
            <div className={styles.sections}>
                <AboutSection
                    ...
                    text="We started FinVault with a simple belief: everyone deserves the financial tools that were once reserved for the wealthy. Our platform brings institutional-grade analytics, goal tracking, and portfolio insights to individuals, startups, and families — without the complexity or steep fees."
                />
                <AboutSection
                    tag="Our Vision"
