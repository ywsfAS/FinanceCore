...
import { type BarChartCardProps, DEFAULT_CONFIG, DEFAULT_DATA, DEFAULT_KEY1, DEFAULT_KEY2, type Data, DEFAULT_LABEL } from "./constants";
    ...
    return (
        ...
        <ResponsiveContainer width="100%" height="70%">
            <BarChart data={data} barGap={-60} barSize={60}>
                ...
                <XAxis dataKey={label} axisLine={false} tickLine={false} tick={config}
                />
